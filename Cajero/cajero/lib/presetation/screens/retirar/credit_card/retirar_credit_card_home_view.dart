...
class RetirarCreditCard extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final timer = useInactivityTimer(
      const Duration(seconds: 30),
      () {
        // Acción a realizar después de la inactividad
        showDialog(
          context: context,
          barrierDismissible: false,
          builder: (context) => AlertDialog(
            title: const Text('Inactividad'),
            content: const Text('Han pasado 30 segundos de inactividad.'),
            actions: <Widget>[
              TextButton(
          ...
          children: [
            DragTarget<CreditCardEntity>(
              ...
              onAccept: (data) {
                ...
                timer
                    .reset(); // Reinicia el temporizador al aceptar una tarjeta
              },
                                  ...
                                  children: [
                                    IconButton(
                                      onPressed: () {
                                        ...
                                        timer
                                            .reset(); // Reinicia el temporizador al presionar el botón de eliminar
                                      },
                                    ...
                                    IconButton(
                                      onPressed: () {
                                        showBackSide.value =
                                            !showBackSide.value;
                                        timer
                                            .reset(); // Reinicia el temporizador al presionar el botón de cambiar lado
                                      },
                                    ...
                                    IconButton(
                                      onPressed: () {
                                        timer
                                            .reset(); // Reinicia el temporizador al presionar el botón de editar
                                      },
                          ...
                          child: IconButton(
                            ...
                            onPressed: () {
                              if (pageController.hasClients) {
                                ...
                                timer
                                    .reset(); // Reinicia el temporizador al navegar hacia atrás
                              }
                            },
                          ),
                        ),
                          ...
                          child: IconButton(
                            ...
                            onPressed: () {
                              if (pageController.hasClients) {
                                ...
                                timer
                                    .reset(); // Reinicia el temporizador al navegar hacia adelante
                              }
                            },
                          ),
                        ),
